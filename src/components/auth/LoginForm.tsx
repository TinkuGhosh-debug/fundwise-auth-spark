...
const LoginForm = ({ onSwitchToSignup, onLogin, onGoogleAuth, onGithubAuth, isLoading }: LoginFormProps) => {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Button
          ...
          disabled={isLoading}
          className="w-full h-12 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 hover:shadow-md transition-all duration-300"
        >
          {isLoading ? (
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="text-sm text-blue-600 hover:text-blue-800 transition-colors hover:underline">
              Forgot password?
            </button>
          </div>
          <div className="relative">
